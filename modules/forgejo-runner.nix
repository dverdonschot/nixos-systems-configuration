...
in
{
  options.services.forgejo-runner = {
    ...
    url = mkOption {
      type = types.str;
      # No default: every host names its Forgejo instance. The URL is
      # state that belongs in the host config (or a shared secrets/
      # network module), not in this reusable module.
      description = ''
        Forgejo instance URL the runner registers with. e.g.
        "https://forgejo.tail5bbc4.ts.net".
      '';
    };
